...
import Holmos.Holmos.element.property.Size;
...
public class Element implements LocatorValue{
	...
	private boolean isElementExist(int waitCount){
		...
		if(currentWindow instanceof SeleniumBrowserWindow)
			return isSeleniumElemenetExist(waitCount);
		else if(currentWindow instanceof WebDriverBrowserWindow)
			return isWebDriverElementExist(waitCount);
		return false;
	}
	private boolean isSeleniumElemenetExist(int waitCount){
		int count=0;
		...
		if(infoChain.getInfoNodes().size()<=1){
			while(count++<waitCount){
				if(findSeleniumElement(seleniumEngine))
					return true;
			}
		}else{
	...
	private boolean findSeleniumElement(Selenium seleniumEngine){
		if(findSeleniumElementById(seleniumEngine))return true;
		if(findSeleniumElementByName(seleniumEngine))return true;
		if(findSeleniumElementByXpath(seleniumEngine))return true;
		if(findSeleniumElementByCss(seleniumEngine))return true;
		if(findSeleniumElementByLinkText(seleniumEngine))return true;
		if(findSeleniumElementByRegularLinkText(seleniumEngine))return true;
		return false;
	}
	private boolean findSeleniumElementById(Selenium seleniumEngine){
	...
	private boolean findSeleniumElementByName(Selenium seleniumEngine){
	...
	private boolean findSeleniumElementByXpath(Selenium seleniumEngine){
	...
	private boolean findSeleniumElementByCss(Selenium seleniumEngine){
	...
	private boolean findSeleniumElementByLinkText(Selenium seleniumEngine){
	...
	private boolean findSeleniumElementByRegularLinkText(Selenium seleniumEngine){
	...
	private boolean findWebDriverElement(LocatorFinder finder){
		if(findWebDriverElementById(finder))return true;
		if(findWebDriverElemntByName(finder))return true;
		if(findWebDriverElemntByXpath(finder))return true;
		if(findWebDriverElemntByCss(finder))return true;
		if(findWebDriverElemntByLinkText(finder))return true;
		if(findWebDriverElemntByPartialLinkText(finder))return true;
		if(findWebDriverElemntByTagName(finder))return true;
		return false;
	}
	private boolean findWebDriverElementById(LocatorFinder finder){
		if(locator.getLocatorById()==null||"".equalsIgnoreCase(locator.getLocatorById()))
			return false;
		try{
	...
	private boolean findWebDriverElemntByName(LocatorFinder finder){
		if(locator.getLocatorByName()==null||"".equalsIgnoreCase(locator.getLocatorByName()))
			return false;
		try{
	...
	private boolean findWebDriverElemntByXpath(LocatorFinder finder){
		if(locator.getLocatorByXpath()==null||"".equalsIgnoreCase(locator.getLocatorByXpath()))
			return false;
		try{
	...
	private boolean findWebDriverElemntByCss(LocatorFinder finder){
		if(locator.getLocatorByCSS()==null||"".equalsIgnoreCase(locator.getLocatorByCSS()))
			return false;
		try{
	...
	private boolean findWebDriverElemntByLinkText(LocatorFinder finder){
		if(locator.getLocatorByLinkText()==null||"".equalsIgnoreCase(locator.getLocatorByLinkText()))
			return false;
		try{
	...
	private boolean findWebDriverElemntByPartialLinkText(LocatorFinder finder){
	...
	private boolean findWebDriverElemntByTagName(LocatorFinder finder){
	...
	public void waitForDisppear() {
		...
		if(currentWindow instanceof SeleniumBrowserWindow){
			while(waitCount++<ConfigConstValue.waitCount){
				if(!findSeleniumElement((Selenium) currentWindow.getDriver().getEngine()))
					return;
			}
		}else if(currentWindow instanceof WebDriverBrowserWindow){
